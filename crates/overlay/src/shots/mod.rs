//! Screenshot discovery, decoding, QR detection, cropping and clipboard —
//! ported from monado-frame. Files live in `~/Pictures/Monado` (Monado's
//! screenshot dir); the gesture detector's config is in `gestures`.
pub mod gestures;
pub mod picsur;
pub mod translate;
